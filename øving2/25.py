...
alpha_values = [0, 0.0001, 0.0005, 0.001, 0.005, 0.01]
...
# Uten class weights
tree_unweighted = DecisionTreeClassifier(random_state=42)
tree_unweighted.fit(X_train, y_train)

pred_unweighted = tree_unweighted.predict(X_val)

# Med class_weight="balanced"
...
pred_balanced = tree_balanced.predict(X_val)

print("\nUNWEIGHTED")
print("Precision:", precision_score(y_val, pred_unweighted))
print("Recall:", recall_score(y_val, pred_unweighted))
print("F1:", f1_score(y_val, pred_unweighted))

print("\nBALANCED")
print("Precision:", precision_score(y_val, pred_balanced))
print("Recall:", recall_score(y_val, pred_balanced))
print("F1:", f1_score(y_val, pred_balanced))
